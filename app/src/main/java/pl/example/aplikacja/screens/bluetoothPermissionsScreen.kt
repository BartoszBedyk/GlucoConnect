...
fun bluetoothPermissionsScreen(
    ...
    Column(
        ...
        PermissionStatusChecker(permissionControl.isPermissionBluetoothConnect(), "BluetoothConnect")
    ...
    dialogQuote
        ...
        PermissionDialog(
            ...
            isPermanentlyDeclined = !activity?.let { shouldShowRequestPermissionRationale(it, permission) }!!,
